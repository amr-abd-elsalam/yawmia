...
describe('Phase 36 — Urgency Config', () => {
  ...
  it('P36-12: Config section count === 49', () => {
    ...
    assert.strictEqual(keys.length, 49, `expected 49, got ${keys.length}: ${keys.join(', ')}`);
  });
});
